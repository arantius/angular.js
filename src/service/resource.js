 ...
 *
 *       {action1: {method:?, params:?, isArray:?, mutate:?, verifyCache:?},
 *        action2: {method:?, params:?, isArray:?, mutate:?, verifyCache:?},
 *        ...}
 *
 *   Where:
 *
 ...
 *     `returns` section.
 *   - mutate – {boolean=} – If true then the resource instance will be mutated to match the server
 *     response.
